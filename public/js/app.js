...
var initAdmin = function initAdmin() {
  ...
  function renderItems(items) {
    var paresdItems = Object.values(items);
    console.log('PARS:', paresdItems);
    return paresdItems.map(function (menuItem) {
      return "\n             <p>".concat(menuItem.item.name, " - ").concat(menuItem.qty, " pec</p>\n            ");
    }).join('');
  }
...
}); //Removw alert message after X sessonds
...
__webpack_require__(/*! D:\Nodejs\realtime-pizza\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\Nodejs\realtime-pizza\resources\scss\app.scss */"./resources/scss/app.scss");
